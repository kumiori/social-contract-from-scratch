...
if __name__ == "__main__":
    ...
    intro()
    st.markdown(f"# <center>Manifesting</center> ", unsafe_allow_html=True)
    ...
    """
    # Sample page for "Manifesto, Collective"
    st.markdown("# Manifesto, Collective")
    st.markdown("### Introduction")
    st.markdown("A manifesto captures the collective vision and commitment of a group, outlining values, goals, and principles. "
                "It formalizes the shared beliefs and objectives of the stakeholders.")
    st.markdown("### Context")
    st.markdown("A manifesto becomes a point of reference for future actions and helps unite people around a common vision.")
    st.markdown("### Question")

    st.write("What key points should be included in the manifesto?")
    manifesto_points = st.text_area("Share your key points for the manifesto:")
    st.write(f"Your manifesto points: {manifesto_points}")

    st.write("What are the core values and principles that should guide this social contract?")
    core_values = st.text_area("Describe the core values and principles:")
    st.write(f"Your core values: {core_values}")    
    """
