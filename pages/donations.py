...
def checkout2():
    ...
    """
    # REMOVE STEP
    if st.button(f"{total_amount}! Let's donate", type='primary', key="checkout", help="Record a trace on the ledger", use_container_width=True, disabled=not bool(st.session_state['sumup'])):
...
### **Support Our Mission at the Social Contract from Scratch Conference**
    ...
    """
We are the **Athena Collective**, a diverse group of 17 thinkers, scientists, and creatives dedicated to reimagining the future of society. In two weeks, we'll be participating in a key panel discussion at the **Europe in Discourse Conference in Athens**, where we'll present our collaborative work, blending philosophy, technology, and social innovation.
...
- Engage participants in live decision-making processes about the future of governance.
- Create a collective understanding of how to bond a society based on **consent, responsibility, and collaboration**.
- Deliver actionable insights and new ideas on participatory governance, involving people from all backgrounds.

**Why We Need Your Support**:  
While our ideas are powerful, bringing them to life requires resources. Our 17-member team will be traveling to Athens to share our work, but we need help covering the **essential costs** of travel, accommodation, food, and conference fees.

By supporting us, you'll be directly contributing to the realization of this exciting and impactful project.

**How You Can Help**:  
We appreciate every contribution, big or small. You can choose to:
- **Sponsor a coffee for the collective** – €17
- **Cover a light lunch or part of a dinner** – €100
- **Support our accommodation** – €1000
- **Support our travels** – €1111
...
"""
    ...
    """
Your generous contribution will be happily acknowledged, and this donation is only the beginning of an exciting partnership. 
If you wish, we will follow up with you, and as a **first donor**, you will benefit from all the positive outcomes that will spring from this initiative, including _inclusive_ insights, future event invitations, and more opportunities for **meaningful philanthropic engagement**.

Join us on this journey toward creating a solid foundation for inclusivity.
"""
