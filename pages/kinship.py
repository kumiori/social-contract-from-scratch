...
def intro():
    ...
    st.divider()
    st.markdown(f"# <center>Collective Kinship</center> ", unsafe_allow_html=True)
...
You've arrived on this page because ...


The core of the collective you’re envisioning is bringing together diverse and innovative minds—artists, academics, entrepreneurs, and thought leaders—to collaborate on projects with a purpose. This collaboration could produce events, experiences, or even movements that aim to make a real impact in the world, rather than simply selling a product or brand, as in traditional experiential marketing.

It focuses on:

- **Facilitating collaborations** among creative, entrepreneurial, and intellectual individuals.
- **Producing immersive experiences or events** that serve as platforms for storytelling, change-making, and community-building.
- **Offering a space for projects** that align with a mission of creating social, cultural, or environmental impact.

It’s not exactly about managing artists or putting on standard events for marketing purposes, but about curating experiences and narratives that inspire and drive change. The emphasis would be on **connection**—connecting ideas, people, and stories in a way that sparks real-world transformation.

So, let’s talk about the money aspect and how this type of collective can generate revenue while staying aligned with its mission.

There are a few different revenue models you could explore for a purpose-driven event production and creative collective like this:


1. **Sponsorships and Partnerships**: we could build relationships with tech companies, purpose-driven brands, or even nonprofits that align with your values. These sponsors could contribute financially in exchange for visibility at your events or being associated with the change-making projects and innovative work that comes out of your collective. Brands are always looking for authentic ways to connect with conscious consumers, and your events could be a powerful platform for that.

2. **Event-Based Revenue**: Charge for the events or experiences themselves. This could include ticket sales, VIP experiences, or even pay-per-view for virtual components. Depending on the scale and exclusivity of the event, pricing could range from affordable to premium, especially if you’re curating unique, impactful experiences that resonate deeply with the audience.

3. **Membership or Subscription Model**: You could create a subscription-based community where people—whether they’re creatives, entrepreneurs, or changemakers—pay a regular fee to be a part of your collective. In exchange, they get access to exclusive content, events, networking opportunities, workshops, and other benefits. This could help create a steady, predictable stream of revenue.

4. **Creative Project Commissioning**: You could generate revenue by producing content or experiences for companies and organizations that need your collective’s talents. These could be branded events, campaigns, or storytelling projects designed to align with their corporate social responsibility goals or brand narratives.

5. **Grants and Philanthropy**: Depending on your focus, there may be grant opportunities available for projects or collectives that focus on social change, the arts, or innovation. Certain foundations and philanthropists might also want to back your work because of its impact on the community or world at large.

6. **Merchandise or Licensing**: If your collective starts building a recognizable brand and ethos, you might even explore selling merchandise or licensing content created through the collective.
"""
...
"""
    code = """
    gitGraph
    commit id: "Traditional Social Contract"
    branch rethink
    checkout rethink
    commit id:"Reform Stakeholder Supremacy"
    commit tag:"Stakeholder Shift"
    checkout main
    commit type: HIGHLIGHT tag:"Tension: Automation & Inequality"
    branch develop
    checkout develop
    commit id:"Focus on Lifelong Learning"
    commit tag:"Innovation & Hybrid Work"
    checkout main
    commit type: HIGHLIGHT tag:"Environmental Crisis"
    branch experience
    checkout experience
    commit id:"Climate Justice & Sustainability"
    commit tag:"Energy Transition"
    checkout main
    merge rethink
    merge develop
    merge experience
    commit id:"New Social Contract"
    """
    # code = """graph TD
    # A --> B
    # """
    ...
    """
But this XXX is only the beginning of a wider journey. ...
"""
