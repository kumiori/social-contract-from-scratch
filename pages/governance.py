...
if __name__ == "__main__":
    ...
    """
    # Sample page for "Collaboration and Governance"
    st.markdown("# Collaboration and Governance")
    st.markdown("### Introduction")
    st.markdown("Collaboration and governance define how people work together, make decisions, and resolve conflicts. "
                "They are essential in shaping a social contract that works for everyone.")
    st.markdown("### Context")
    st.markdown("Governance structures ensure fair participation, accountability, and collective success.")
    st.markdown("### Question")

    st.write("Which governance structures do you think foster the most effective collaboration?")
    governance_structure = st.selectbox("Choose a governance structure:", 
                                        ["Direct Democracy", "Representative Democracy", "Anarchism", "Corporate Governance", "Consensus-Based Governance"])
    st.write(f"You selected: {governance_structure}")

    st.write("What are the key elements of successful collaboration in your view?")
    collaboration_elements = st.text_area("Describe the key elements:")
    st.write(f"Your key elements of collaboration: {collaboration_elements}")    
    """
