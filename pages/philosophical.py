...
# Sample page for "The Philosophical Basis"
    st.markdown("# The Philosophical Basis")
    st.markdown("### Introduction")
    st.markdown("At its core, the social contract is a philosophical concept, balancing personal freedom with collective responsibility. "
                "Understanding this helps us shape systems that reflect ethical principles.")
    st.markdown("### Context")
    st.markdown("Philosophical concepts like justice, equality, freedom, and responsibility guide the development of a fair and equitable social contract.")
    st.markdown("### Question")

    st.write("Which philosophical concepts do you think should guide the creation of a new social contract?")
    philosophical_concepts = st.multiselect("Select philosophical concepts:", 
                                            ["Justice", "Equality", "Freedom", "Responsibility", "Solidarity", "Sustainability"])
    st.write(f"Selected concepts: {philosophical_concepts}")

    st.write("How do these concepts shape our understanding of freedom, equality, and justice?")
    philosophical_reflection = st.text_area("Share your reflection:")
    st.write(f"Your reflection: {philosophical_reflection}")    
    """
