...
if __name__ == "__main__":
    ...
    intro()
    st.markdown(f"# <center>The Stakeholders</center> ", unsafe_allow_html=True)
    """### Who is involved"""
    ...
    # Sample page for "The Stakeholders"
    st.markdown("### Introduction")
    st.markdown("Every social contract is built upon the relationships between stakeholders—individuals, communities, governments, businesses, and the environment.")
    st.markdown("### Context")
    st.markdown("Understanding who is involved is essential in identifying responsibility and the impact of policies.")
    st.markdown("### Question")
    st.write("Individuals and their Environment are the essential stakeholders for this social contract. How should otherwise their interests be represented?")
    st.write("Do you wish that other stakeholders be included in this SC, do you think other stakeholders should be included in this SC?")
    
    stakeholders = st.multiselect("If yes, select stakeholders:", ["Other Individuals", "Local Communities", "Corporations", "Governments", "NGOs", "Environment"])
    st.write(f"Selected stakeholders: {stakeholders}")
    """
